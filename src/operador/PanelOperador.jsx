...
useEffect(() => {
  ...
  if (storedUser && storedUser.tipo === "OPERADOR") {
    setUser(storedUser);
  } else {
    navigate("/login");
    return;
  ...
  // 🔹 Si el operador entra a /operador, redirigir automáticamente a /operador/mapa
  if (window.location.pathname === "/operador") {
    navigate("/operador/mapa");
  }
}, [navigate]);
